    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/resources/index2.html" class="logo">
          ...
          <span class="logo-lg"><b>SpringMVC</b> PROJECT</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><span>HOME</span><i class="fa fa-angle-left pull-right"></i></a></li>
            <li class="treeview"><a href="/sboard/list"><span>BOARD</span><i class="fa fa-angle-left pull-right"></i></a></li>
            <li class="treeview"><a href="/test"><span>RPLEY Test</span><i class="fa fa-angle-left pull-right"></i></a></li>
            <li class="treeview"><a href="/uploadForm"><span>UPLOAD Test</span><i class="fa fa-angle-left pull-right"></i></a></li>
            <li class="treeview"><a href="/uploadAjax"><span>UPLOAD Drag Test</span><i class="fa fa-angle-left pull-right"></i></a></li>
            <li class="treeview">
              <a href="#">
